...
import { ELAPSED_TIME_NOTE } from "@/lib/elapsed-time-format";
        ...
        <section className="space-y-8">
          ...
          {otherWorkflows.map((workflow) => (
            ...
            <ModernReportCard
              ...
              description={`Specialist workflow elapsed wait time for the same global date range and project selection. ${ELAPSED_TIME_NOTE}`}
...
function MainWorkflowBlock({
  ...
  return (
    ...
    <ModernReportCard
      ...
      description={`${ELAPSED_TIME_NOTE} Issue-type pills filter instantly without reloading. Expand a status to see the longest-waiting issues by priority.`}
